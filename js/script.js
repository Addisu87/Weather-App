...
let weatherAPIKey = '6a40eacef2e7e6825dbb118bfcd00ce9';
let weatherBaseEndPoint = "http://api.openweathermap.org/data/2.5/weather?units=metric&appid=" 
     + weatherAPIKey;
let forecastBaseEndpoint = "http://api.openweathermap.org/data/2.5/forecast?units=metric&appid=" 
     + weatherAPIKey;
